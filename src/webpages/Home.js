...
At an affordable cost of around $5 per device, Sensor Sight Assist stands out as an economical choice for those seeking accessibility solutions. With an estimated total cost of $30 to $50 for the entire tool (including one device for each room), our product is not only effective but also budget-friendly. Our business model aims for sustainable growth, with revenue estimated at around $3 per device, making Sensor Sight Assist an accessible and impactful solution for individuals facing vision challenges in various settings. Join us in making a positive impact on the lives of those who need it most.
          </p>
        </section>

        <section style={{alignItems:'center', justifyContent:'center'}}>
        <Image source={require('../images/IMG_3832.jpg')} style={{ width: 450, height: 450, resizeMode: 'cover', marginTop: '10%', marginLeft:'15%', borderRadius: '15px', alignContent:'center', justifyContent:'center'}} />

        <Image source={require('../images/prototype.jpeg')} style={{ width: 450, height: 450, resizeMode: 'cover', marginTop: '10%', marginLeft:'15%', borderRadius: '15px', alignContent:'center', justifyContent:'center'}} />
        </section>
      </main>
